...
│
├── data/
│   ├── raw/             # Original Kaggle CSVs (Do not edit these!)
│   └── processed/       # Cleaned parquet/csv files generated by notebooks
│
├── models/
│   ├── oof_*.csv        # Out-of-fold predictions for each model
│   └── preds_*.csv      # Test set predictions for each model
│
├── notebooks/
│   ├── 01_exploration.ipynb       # Visualization & Data Download
│   ├── 02_preprocessing_nn.ipynb  # NN-specific Feature Engineering
│   ├── 03_make_folds.ipynb        # StratifiedKFold Cross-Validation Setup
│   ├── 04_XGBoost.ipynb           # XGBoost Training with Optuna
